    ...
    <main class="pt-90">
        ...
        <section class="shop-checkout container">
            ...
            <div class="checkout-steps">
                ...
                <a href="javascript:voide(0)" class="checkout-steps__item active">
                ...
                <a href="javascript:voide(0)" class="checkout-steps__item">
                            ...
                            <div class="checkout__payment-methods">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input form-check-input_fill" type="radio" name="mode"
                                        id="mode1" value="cart">
                                    <label class="form-check-label" for="checkout_payment_method_1"> Debit or Credit Card
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input form-check-input_fill" type="radio" name="mode"
                                        id="mode2" value="cod">
                                    <label class="form-check-label" for="checkout_payment_method_2"> Cash on delivery
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input form-check-input_fill" type="radio" name="mode"
                                        id="mode3" value="paypal">
                                    <label class="form-check-label" for="checkout_payment_method_3"> Paypal </label>
                                </div>
