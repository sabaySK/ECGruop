      ...
      <div class="row">
        ...
        <div class="col-lg-5">
          ...
          <div class="product-single__rating">
            ...
            <span class="reviews-note text-lowercase text-secondary ms-1">{{$product->slug}}</span>
          </div>
          ...
          <div class="product-single__addtolinks">
            ...
            @else
              <form method="POST" action="{{ route('wishlist.add') }}" id="wishlist_form">
                ...
                <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <use href="#icon_heart" />
            ...
            @foreach ($rproducts as $rproduct)
              <div class="swiper-slide product-card">
                <div class="pc__img-wrapper">
                  <a href="{{route('shop.product_details', ['product_slug'=>$rproduct->slug])}}">
