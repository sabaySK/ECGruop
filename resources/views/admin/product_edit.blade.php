...
<div class="main-content-inner">
    ...
    <div class="main-content-wrap">
        ...
        <!-- form-add-product -->
        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('admin.product_update', $product->id)}}">
            @csrf
            @method('PUT')
            ...
            <div class="wg-box">
                ...
                @error('slug') <span class="alert danger-text text-center">{{$message}}</span> @enderror
                ...
                <fieldset class="shortdescription">
                    ...
                    <textarea class="mb-10 ht-150" name="short_description" placeholder="Short Description" value="" tabindex="0" aria-required="true" required="">{{$product->short_description}}</textarea>
                    <div class="text-tiny">Do not exceed 100 characters when entering the product name.</div>
                </fieldset>
                @error('short_description') <span class="alert danger-text text-center">{{$message}}</span> @enderror

                <fieldset class="description">
                    <div class="body-title mb-10">Description <span class="tf-color-1">*</span></div>
                    <textarea class="mb-10" name="description" placeholder="Description" tabindex="0" value="" aria-required="true" required="">{{$product->description}}</textarea>
                    <div class="text-tiny">Do not exceed 100 characters when entering the product name.</div>
                </fieldset>
                @error('description') <span class="alert danger-text text-center">{{$message}}</span> @enderror
            </div>
            <div class="wg-box">
                <fieldset>
                ...
                @error('image') <span class="alert danger-text text-center">{{$message}}</span> @enderror
                        ...
                        @if ($product->images)
                            @foreach (explode(',', $product->images) as $img)
                                <div class="item gitems">
                                    <img src="{{asset('uploads/products/thumbnail')}}/{{trim($img)}}" alt="">
                                </div> 
                            @endforeach
                        @endif
                ...
                @error('images') <span class="alert danger-text text-center">{{$message}}</span> @enderror
                ...
                <div class="cols gap22">
                    ...
                    @error('regular_price') <span class="alert danger-text text-center">{{$message}}</span> @enderror
                    ...
                    @error('sale_price') <span class="alert danger-text text-center">{{$message}}</span> @enderror
                </div>
                ...
                <div class="cols gap22">
                    ...
                    @error('SKU') <span class="alert danger-text text-center">{{$message}}</span> @enderror
                    ...
                    @error('quantity') <span class="alert danger-text text-center">{{$message}}</span> @enderror
                </div>
                ...
                <div class="cols gap22">
                    ...
                    @error('stock_status') <span class="alert danger-text text-center">{{$message}}</span> @enderror
                    <fieldset class="name">
                    ...
                    @error('featured') <span class="alert danger-text text-center">{{$message}}</span> @enderror
                </div>
